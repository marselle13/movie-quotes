    ...
    <div class="flex h-20 items-center justify-center">
        <div>
            <div class="flex space-x-4">
                ...
                @auth
                    <a href="/admin/movies"
                       class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium {{request()->is('admin/movies') ? "bg-gray-900" : ""}}">{{trans('messages.dashboard')}}</a>
